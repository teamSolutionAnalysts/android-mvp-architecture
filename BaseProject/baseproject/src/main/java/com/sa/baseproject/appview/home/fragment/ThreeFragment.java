...
public class ThreeFragment extends AppFragment {
    ...
    public void initializeComponent(View view) {
        final Button btnNext = (Button) view.findViewById(R.id.fragment_3_btn_next);
        btnNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((AppActivity) getActivity()).getAppFragmentManager().addFragment(AppFragmentState.F_FOUR, null, true);
            }
        });
    }
